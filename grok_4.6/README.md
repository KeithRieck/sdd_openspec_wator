Hosted at:  https://keithrieck.github.io/sdd_openspec_wator/grok_4.6/index.html

# Wa-Tor simulations with Grok 4.6
...
This project used the closed-weight model [Grok 4.6](https://artificialanalysis.ai/models/grok-4-6-medium) on Medium level.   The 4.6 model was just released, and SpaceX is offering it on discount. I'm developing with Visual Studio Code's [chat panel](https://code.visualstudio.com/docs/chat/chat-overview).
...
1. Exploration step:
    ...
    - Openspec under VS Code asked permission to visit Wikipedia to learn about Wator. I allowed this. This may be the first time a model has looked up the Wikipedia page.  Also, Grok asked to look at the sibling projects code;  I did not allow that.
