...
This project used the open-weight model [Gemma 4 26B](https://artificialanalysis.ai/models/gemma-4-26b-a4b) developed by Google in the United States.  I'm developing with the Visual Studio Code (1.130.0) [chat panel](https://code.visualstudio.com/docs/chat/chat-overview).
