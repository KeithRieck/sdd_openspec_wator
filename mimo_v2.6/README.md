Hosted at:  https://keithrieck.github.io/sdd_openspec_wator/mimo_v2.6/index.html

# Wa-Tor simulations with MiMo-V2.6-Pro
...
This project used the Chinese open-weight model [MiMo-V2.6-Pro](https://artificialanalysis.ai/models/mimo-v2-6-pro) level.  I'm developing with the Visual Studio Code (1.130.0) [chat panel](https://code.visualstudio.com/docs/chat/chat-overview).
