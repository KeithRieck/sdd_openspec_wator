...
3. Apply step:
    ...
    - `The drawWorld function is called, but no fish or sharks are displayed on the #sym:worldGfx  object.  After 5 chronons, all the sharks die.`
    ...
    - `To @sym:Entity , add abstract properties for circle radius and color.  Override these appropriately in the @sym:Shark and @sym:Fish classes.  Change the SimulationScene.drawWorld function to use these values when drawing circles.`
